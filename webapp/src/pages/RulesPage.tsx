  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <Card className="frame-ornate">
        ...
        <CardBody>
          <p style={{ color: 'var(--night-text-secondary)', marginBottom: '20px' }}>
      ...
      <Card className="frame-ornate">
        <CardBody>
          <div className="flex" style={{ gap: '16px', alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: 1 }}>
              <p style={{ fontWeight: 600, marginBottom: '8px', color: 'var(--night-text-primary)' }}>
                Téléchargement automatique des nouveaux épisodes
              </p>
              <p style={{ color: 'var(--night-text-secondary)', fontSize: '13px', lineHeight: '1.6' }}>
