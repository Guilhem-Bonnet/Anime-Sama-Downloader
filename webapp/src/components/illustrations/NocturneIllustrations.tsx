...
export const EmptySearchIllustration: React.FC = () => {
  return (
    <div className="night-illustration">
      <svg
        width="320"
        height="200"
        viewBox="0 0 320 200"
        ...
        className="night-float"
        role="img"
        aria-label="Illustration de recherche"
      >
        <defs>
          <linearGradient id="night-search-gradient" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#8b7a5a" />
            <stop offset="55%" stopColor="#6b7280" />
            <stop offset="100%" stopColor="#4b5563" />
          </linearGradient>
          <radialGradient id="night-search-glow" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(160 160) rotate(90) scale(90 140)">
            <stop offset="0%" stopColor="#8b7a5a" stopOpacity="0.14" />
            <stop offset="100%" stopColor="#0f172a" stopOpacity="0" />
          </radialGradient>
          <linearGradient id="night-search-panel" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#111827" />
            <stop offset="100%" stopColor="#0b0f19" />
          </linearGradient>
          <linearGradient id="night-ink-stroke" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#3f4a34" />
            <stop offset="100%" stopColor="#5c6b4a" />
          </linearGradient>
          <linearGradient id="night-paper" x1="0" y1="0" x2="0" y2="1">
        ...
        {/* Subtle base */}
        <ellipse cx="160" cy="165" rx="130" ry="24" fill="url(#night-search-glow)" />
        ...
        {/* Card */}
        <rect x="54" y="52" width="212" height="112" rx="18" fill="url(#night-paper)" opacity="0.96" />
        ...
        {/* Lens */}
        <circle cx="210" cy="95" r="18" stroke="url(#night-search-gradient)" strokeWidth="3" />
        <line x1="222" y1="107" x2="238" y2="123" stroke="url(#night-search-gradient)" strokeWidth="3" strokeLinecap="round" />
        ...
        {/* Paper fibers */}
        <path d="M72 96C88 92 110 92 128 98" stroke="url(#night-ink-stroke)" strokeWidth="1.5" strokeLinecap="round" opacity="0.35" />
...
export const EmptyDownloadsIllustration: React.FC = () => {
  return (
    <div className="night-illustration">
      ...
      >
        <defs>
          <linearGradient id="night-download-gradient" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#8b7a5a" />
            <stop offset="50%" stopColor="#6b7280" />
            <stop offset="100%" stopColor="#4b5563" />
          </linearGradient>
          <linearGradient id="night-box" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#0f172a" />
            <stop offset="100%" stopColor="#0b1220" />
          </linearGradient>
          <linearGradient id="night-wind" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#3f4a34" />
            <stop offset="100%" stopColor="#6b7b4e" />
          </linearGradient>
          <linearGradient id="night-wood" x1="0" y1="0" x2="0" y2="1">
        ...
        {/* Wind lines */}
        <path d="M24 86C52 78 86 78 112 84" stroke="url(#night-wind)" strokeWidth="2" strokeLinecap="round" opacity="0.45" />
        ...
        {/* Box */}
        <rect x="90" y="58" width="140" height="96" rx="16" fill="url(#night-box)" stroke="#1f2937" strokeWidth="2" />
        <rect x="96" y="64" width="128" height="8" rx="4" fill="url(#night-wood)" opacity="0.9" />
        ...
        {/* Arrow */}
        <path d="M160 40V80" stroke="url(#night-download-gradient)" strokeWidth="5" strokeLinecap="round" />
        <path d="M146 68L160 86L174 68" stroke="url(#night-download-gradient)" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
        <circle cx="160" cy="34" r="6" fill="#8b7a5a" opacity="0.45" />

        {/* Leaves */}
        <path d="M72 104C78 96 90 96 96 104C99 110 92 116 84 116C76 116 69 110 72 104Z" fill="#5c6b4a" opacity="0.55" className="night-drift" />
        <path d="M246 102C252 94 264 94 270 102C273 108 266 114 258 114C250 114 243 108 246 102Z" fill="#6b7b4e" opacity="0.55" className="night-drift" />
        <path d="M232 138C238 130 250 130 256 138C259 144 252 150 244 150C236 150 229 144 232 138Z" fill="#4b5563" opacity="0.5" className="night-drift" />
        <path d="M86 138C92 130 104 130 110 138C113 144 106 150 98 150C90 150 83 144 86 138Z" fill="#64748b" opacity="0.5" className="night-drift" />
      </svg>
    </div>
  );
};
...
export const SuccessIllustration: React.FC = () => {
  return (
    <div className="night-illustration">
      ...
      >
        <defs>
          <linearGradient id="night-success-gradient" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#8b7a5a" />
            <stop offset="100%" stopColor="#6b7b4e" />
          </linearGradient>
        </defs>

        <circle cx="120" cy="90" r="52" fill="#0f172a" stroke="url(#night-success-gradient)" strokeWidth="6" />
        <path d="M92 92L112 112L148 74" stroke="url(#night-success-gradient)" strokeWidth="7" strokeLinecap="round" strokeLinejoin="round" />
