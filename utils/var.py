...
╚══════════════════════════════════════════════════════════════╝
{Colors.ENDC}
{Colors.OKCYAN}📺 Download anime episodes from anime-sama.tv easily!{Colors.ENDC}
"""
    print(header)
...
├─ 🌐 Visit: {Colors.OKCYAN}https://anime-sama.tv/catalogue/{Colors.ENDC}
...
└─ ✅ Example URL format:
    {Colors.OKCYAN}https://anime-sama.tv/catalogue/roshidere/saison1/vostfr/{Colors.ENDC}
